...
export default function DekanDashboard() {
    ...
    const fetchStats = async () => {
        try {
            // Assuming the backend handles role-based stats return
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="bg-gradient-to-br from-indigo-600 to-indigo-800 dark:from-indigo-900 dark:to-indigo-950 rounded-2xl p-8 text-white shadow-xl relative overflow-hidden ring-1 ring-white/10 dark:ring-white/5 shadow-neon">
                ...
                <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center justify-between">
                    <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2 text-indigo-100">
                            ...
                            <span className="font-medium tracking-wide">PROGRESS RPS FAKULTAS</span>
                        </div>
                        <div className="text-5xl font-bold mb-2 tracking-tight">
                            {stats?.rpsStats?.completionRate || 0}%
                        </div>
                        <p className="text-indigo-100 opacity-90 max-w-md">
                            Persentase mata kuliah di seluruh program studi yang telah memiliki dokumen RPS <b>Approved</b>.
                        </p>
                    </div>
                    ...
                    <div className="flex gap-4 md:gap-8 bg-white/10 backdrop-blur-sm p-4 rounded-xl border border-white/10">
                        ...
                        <div className="text-center px-4 border-r border-white/10 last:border-0 text-accent-300">
                            ...
                            <div className="text-xs uppercase tracking-wider opacity-70">Butuh Approval</div>
                        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                {stats?.rpsStats?.pending > 0 ? (
                    <div className="bg-accent-50 dark:bg-accent-900/10 border border-accent-200 dark:border-accent-800 rounded-xl p-6 relative overflow-hidden group hover:shadow-md transition-shadow">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-sm text-accent-700 dark:text-accent-300 mb-4">
                                Dokumen RPS yang perlu tinjauan dan persetujuan Dekan.
                            </p>
                            <Link to="/dekan/rps-approval?status=pending" className="inline-flex items-center text-sm font-semibold text-accent-700 hover:text-accent-900 dark:text-accent-400 dark:hover:text-accent-200">
                    ...
                    <div className="bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-800 rounded-xl p-6">
                        ...
                        <p className="text-sm text-green-700 dark:text-green-300">
                            Tidak ada antrian approval RPS saat ini.
                        </p>
                    </div>
                )}
                ...
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 group hover:border-primary-300 dark:hover:border-primary-700 transition-colors">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                        Lihat rekapitulasi ketersediaan RPS per Prodi.
                    </p>
                    <Link to="/dekan/rps-summary" className="inline-flex items-center text-sm font-semibold text-primary-600 hover:text-primary-700">
                ...
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 group hover:border-secondary-300 dark:hover:border-secondary-700 transition-colors">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                        Lihat struktur mata kuliah dan sebaran CPL Fakultas.
                    </p>
                    <Link to="/dekan/curriculum" className="inline-flex items-center text-sm font-semibold text-secondary-600 hover:text-secondary-700">
                        Lihat Kurikulum <ArrowRight className="w-4 h-4 ml-1" />
                    </Link>
                </div>
            </div>
        </div>
